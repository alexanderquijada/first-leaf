...
const CASES = [
  ...
  { rule: 'S3', why: 'disclaimer no longer says "not financial advice"', mutate: (d) => set(d, 'meta.disclaimer', 'Every fund here is made up. For learning only.') },
  ...
  { rule: 'T4', why: 'story no longer says the rate is made up', mutate: (d) => { d['story-p302'].assumptions.note = 'Markets grow 6% a year.'; } },
