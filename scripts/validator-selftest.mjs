...
const CASES = [
  ...
  { rule: 'R2', why: 'the dip window moves to June 1 without recomputing (the high would be June 2, $91.34)', mutate: (d) => { d['story-p302'].rosaStory['rosa-starter'].facts.dip.window.from = '2026-06-01'; } },
