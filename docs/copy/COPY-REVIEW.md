...
**What this covers:** all 757 pieces of text a person can read or hear in First Leaf: every string in the copy files and the text that comes from the data (alerts, the ten investments, the story's sentences, the glossary). Built by `npm run copy:review` from the live pages.
...
1. Approve the new Phase 5 rows (all DRAFT, all grade 8 or below). Each fixes a reviewer finding; the "Why" column says which.
2. Optional, carried from Phase 2: the below-what-you-put-in chart sentence (**H16**) and "you set" on the mix card (**H31**).
...
| H33<br>APPROVED | Activity (laptop, phone); Home (laptop); Investments (laptop)<br><sub>`home:mix.colFund`</sub> | Investment | label | Nothing needs you: same<br>Brand-new: same | — |  |
...
| H39<br>APPROVED | Home (laptop, phone); Alerts (laptop, phone); Activity (laptop, phone); and 11 more screens<br><sub>`home:goal.barValue`</sub> | Word of the day *(and 74 more like it)* | -2.2 | Nothing needs you: “Word of the day”<br>Brand-new: “Word of the day” | — |  |
...
| H48<br>APPROVED | Home (laptop, phone); Your money story (laptop, phone); Words (laptop, phone); Word explanation<br><sub>`home:week.market`</sub> | The market | label | Nothing needs you: same<br>Brand-new: same | — |  |
...
| H56<br>APPROVED | Home (phone); Your money story (laptop)<br><sub>`home:welcome.cashWord`</sub> | cash | label | Nothing needs you: same<br>Brand-new: same | — |  |
...
| H67<br>APPROVED | Alerts (laptop, phone); Home (laptop); Try-again dialog; and 2 more screens<br><sub>`home:phone.fyiTitle`</sub> | Good to know | label | Nothing needs you: same<br>Brand-new: not shown | — |  |
...
| H76<br>APPROVED | Home (laptop, phone); Word explanation<br><sub>`home:phone.someDown`</sub> | Some of your investments went down this week. Ups and downs are normal. | 1.5 | Nothing needs you: same<br>Brand-new: not shown | — |  |
...
| H83<br>APPROVED | Home (phone)<br><sub>`home:phone.readMoreAbout`</sub> | about Ups and downs *(and 1 more like it)* | label | Nothing needs you: same<br>Brand-new: same | — |  |
...
| L3<br>APPROVED | Alerts (laptop, phone); Home (laptop); Try-again dialog; and 2 more screens<br><sub>`shared:severity.fyi`</sub> | Good to know | label | Nothing needs you: same<br>Brand-new: not shown | — |  |
...
| L9<br>APPROVED | Alerts (laptop, phone); Home (laptop); Try-again dialog; and 2 more screens<br><sub>`shared:alerts.fyiTitle`</sub> | Good to know | label | Nothing needs you: same<br>Brand-new: not shown | — |  |
...
| L46<br>APPROVED | Activity (laptop, phone); Home (laptop); Investments (laptop)<br><sub>`alerts:facts.fund`</sub> | Investment | label | Nothing needs you: same<br>Brand-new: same | — |  |
...
| L54<br>DRAFT | Alerts<br><sub>`alerts:facts.triedAgain`</sub> | Tried again *(not on a captured screen; example values)* | label | Same words wherever it shows | — | New in Phase 5: the P301 reviewer found that a returned deposit could be retried again and again; the alert now shows the retry as a fact. |
| L55<br>DRAFT | Alerts<br><sub>`alerts:facts.pendingSince`</sub> | Pending since Sept. 18 *(not on a captured screen; example values)* | label | Not on a captured screen; the values change with the account | — | New in Phase 5: the P301 reviewer found that a returned deposit could be retried again and again; this is the retry fact's value. |
| L56<br>DRAFT | Alerts<br><sub>`alerts:pausedUntilToday`</sub> | Auto-invest was paused from Sept. 18 until today. Deposits in that time stayed as cash. *(not on a captured screen; example values)* | 5.4 | Not on a captured screen; the values change with the account | — | New in Phase 5: the P301 reviewer found that "What happened" still said auto-invest "has been paused" after it was turned on. |
| L57<br>APPROVED | Home (laptop, phone); Alerts (laptop, phone); Try-again dialog; and 2 more screens<br><sub>`data:attention.deposit-returned.title`</sub> | Your $150 deposit from Sept. 1 was sent back | 5.0 | Nothing needs you: not shown<br>Brand-new: not shown | — |  |
| L58<br>APPROVED | Alerts (laptop, phone); Try-again dialog<br><sub>`data:attention.deposit-returned.body`</sub> | Your bank sent it back on Sept. 3, so the money never reached First Leaf. Your investments were not touched. | 3.1 | Nothing needs you: not shown<br>Brand-new: not shown | — |  |
| L59<br>APPROVED | Alerts (laptop, phone); Try-again dialog<br><sub>`data:attention.deposit-returned.nextStep`</sub> | Check your bank account first. Then you can try the deposit again. | 2.5 | Nothing needs you: not shown<br>Brand-new: not shown | — |  |
| L60<br>APPROVED | Alerts (laptop, phone); Try-again dialog<br><sub>`data:attention.deposit-returned.action.label`</sub> | Try the deposit again | 6.6 | Nothing needs you: not shown<br>Brand-new: not shown | — |  |
| L61<br>APPROVED | Alerts (laptop, phone); Home (laptop); Try-again dialog; and 2 more screens<br><sub>`data:attention.goal-behind.title`</sub> | Your goal is $150 behind your plan | 2.3 | Nothing needs you: not shown<br>Brand-new: not shown | — |  |
| L62<br>APPROVED | Alerts (laptop, phone)<br><sub>`data:attention.goal-behind.body`</sub> | You planned to put in $1,400 by now. So far $1,250 went through. This only counts deposits, not the market. | 2.4 | Nothing needs you: not shown<br>Brand-new: not shown | — |  |
| L63<br>APPROVED | Alerts (laptop, phone)<br><sub>`data:attention.goal-behind.nextStep`</sub> | You can add a one-time deposit to catch up, or keep going as planned. Either is fine. | 2.3 | Nothing needs you: not shown<br>Brand-new: not shown | — |  |
| L64<br>APPROVED | Alerts (laptop, phone)<br><sub>`data:attention.goal-behind.action.label`</sub> | Add a one-time deposit | 6.6 | Nothing needs you: not shown<br>Brand-new: not shown | — |  |
| L65<br>APPROVED | Alerts (laptop, phone); Home (laptop); Try-again dialog; and 2 more screens<br><sub>`data:attention.cash-sitting.title`</sub> | $302.27 is waiting in cash | 2.9 | Nothing needs you: not shown<br>Brand-new: not shown | — |  |
| L66<br>APPROVED | Alerts (laptop, phone); Auto-invest dialog<br><sub>`data:attention.cash-sitting.body`</sub> | Auto-invest has been paused since June 8, so deposits since then stay as cash. Cash does not go up or down with the market. | 4.3 | Nothing needs you: not shown<br>Brand-new: not shown | — |  |
| L67<br>APPROVED | Alerts (laptop, phone); Auto-invest dialog<br><sub>`data:attention.cash-sitting.nextStep`</sub> | It is your choice. You can turn auto-invest back on, or leave it paused. | 1.5 | Nothing needs you: not shown<br>Brand-new: not shown | — |  |
| L68<br>APPROVED | Alerts (laptop, phone); Auto-invest dialog<br><sub>`data:attention.cash-sitting.action.label`</sub> | See auto-invest settings | label | Nothing needs you: not shown<br>Brand-new: not shown | — |  |
| L69<br>APPROVED | Alerts (laptop, phone); Home (laptop); Try-again dialog; and 2 more screens<br><sub>`data:attention.sipc-crypto.title`</sub> | SIPC protection doesn't cover crypto | 7.6 | Nothing needs you: same<br>Brand-new: not shown | — |  |
| L70<br>APPROVED | Alerts (laptop, phone); Investments (laptop, phone)<br><sub>`data:attention.sipc-crypto.body`</sub> | SIPC protection covers stocks and cash at a member brokerage if the brokerage fails. It doesn't cover crypto, such as Bitcoin or Ethereum. It never covers a drop in price. | 6.0 | Nothing needs you: same<br>Brand-new: not shown | — |  |
| L71<br>APPROVED | Alerts (laptop, phone)<br><sub>`data:attention.sipc-crypto.nextStep`</sub> | Nothing to do. This is just so you know. | -0.7 | Nothing needs you: same<br>Brand-new: not shown | — |  |
...
| V44<br>APPROVED | Activity (laptop, phone); Home (laptop); Investments (laptop)<br><sub>`activity:facts.fund`</sub> | Investment | label | Nothing needs you: same<br>Brand-new: same | — |  |
...
| F9<br>APPROVED | Investments (laptop, phone); Your money story (phone); Words (laptop, phone)<br><sub>`funds:kind.stock`</sub> | Stock | label | Nothing needs you: same<br>Brand-new: same | — |  |
...
| F42<br>DRAFT | Investments (laptop, phone)<br><sub>`funds:dividends.exDateWord`</sub> | ex-dividend date | label | Nothing needs you: same<br>Brand-new: same | — | New in Phase 5: the P301 reviewer found that "ex-dividend date" had no explanation; the word is now a term button (same words). |
...
| F45<br>APPROVED | Investments (laptop, phone)<br><sub>`funds:dividends.yours`</sub> | You got $0.43 in dividends from it. *(and 4 more like it)* | 4.0 | Nothing needs you: “You got $0.49 in dividends from it.”<br>Brand-new: not shown | — |  |
...
| F47<br>APPROVED | Investments (laptop, phone)<br><sub>`funds:sipc.heading`</sub> | Not covered by SIPC protection | 5.2 | Nothing needs you: same<br>Brand-new: same | — |  |
| F48<br>APPROVED | Alerts (laptop, phone); Investments (laptop, phone); Words (laptop, phone)<br><sub>`funds:sipc.termWord`</sub> | SIPC protection | label | Nothing needs you: same<br>Brand-new: same | — |  |
| F49<br>APPROVED | Alerts (laptop, phone); Investments (laptop, phone)<br><sub>`funds:sipc.body`</sub> | SIPC protection covers stocks and cash at a member brokerage if the brokerage fails. It doesn't cover crypto, such as Bitcoin or Ethereum. It never covers a drop in price. | 6.0 | Nothing needs you: same<br>Brand-new: same | — |  |
...
| F52<br>DRAFT | Investments (laptop, phone)<br><sub>`funds:lossNote`</sub> | Prices go up and down. What you own can be down for a while and up later, or the other way around. | 2.6 | Nothing needs you: same<br>Brand-new: not shown | — | New in Phase 5: the P301 reviewer found no "ups and downs are normal" note for a loss on a laptop, which the brief promises. |
...
| F67<br>APPROVED | Investments (laptop, phone); Words (laptop, phone)<br><sub>`data:funds.BTC.name`</sub> | Bitcoin | label | Nothing needs you: same<br>Brand-new: same | — |  |
...
| S19<br>DRAFT | Your money story<br><sub>`story:sinceMarch.chartTitle1m`</sub> | Your balance in the last month *(not on a captured screen; example values)* | 0.5 | Same words wherever it shows | — | New in Phase 5: the P302 reviewer found that chapter 1's title said "since March" with 1 month selected. |
| S20<br>DRAFT | Your money story<br><sub>`story:sinceMarch.chartTitle3m`</sub> | Your balance in the last 3 months *(not on a captured screen; example values)* | 2.3 | Same words wherever it shows | — | New in Phase 5: the P302 reviewer found that chapter 1's title said "since March" with 3 months selected. |
| S21<br>DRAFT | Your money story (laptop, phone)<br><sub>`story:sinceMarch.layersOn`</sub> | The flat layer is what you put in, and the grainy layer above it is what it earned. | 5.9 | Nothing needs you: same<br>Brand-new: not shown | — | New in Phase 5: the P302 reviewer found that the layers toggle changed no sentence (the brief: each toggle says what the chart now shows). |
| S22<br>DRAFT | Your money story<br><sub>`story:sinceMarch.layersOff`</sub> | The chart shows your balance as one line. *(not on a captured screen; example values)* | 0.8 | Same words wherever it shows | — | New in Phase 5: the P302 reviewer found that the layers toggle changed no sentence. |
| S23<br>APPROVED | Your money story<br><sub>`story:share.readIn`</sub> | $150 of your balance is money you put in. That is 52%. *(not on a captured screen; example values)* | 2.5 | Not on a captured screen; the values change with the account | — |  |
| S24<br>APPROVED | Your money story<br><sub>`story:share.readEarned`</sub> | $150 is what it earned. That is 52%. *(not on a captured screen; example values)* | 0.7 | Not on a captured screen; the values change with the account | — |  |
| S25<br>APPROVED | Your money story (laptop, phone)<br><sub>`story:share.readHint`</sub> | Tap either part to read it. | 0.5 | Nothing needs you: same<br>Brand-new: not shown | — |  |
| S26<br>APPROVED | Your money story (laptop, phone)<br><sub>`story:share.colPart`</sub> | Part | label | Nothing needs you: same<br>Brand-new: not shown | — |  |
| S27<br>APPROVED | Alerts (laptop, phone); Activity (laptop, phone); Investments (laptop, phone); and 3 more screens<br><sub>`story:share.colAmount`</sub> | Amount | label | Nothing needs you: same<br>Brand-new: same | — |  |
| S28<br>APPROVED | Activity (laptop, phone); Investments (phone); Your money story (laptop, phone); Words (laptop, phone)<br><sub>`story:share.colShare`</sub> | Share | label | Nothing needs you: same<br>Brand-new: same | — |  |
| S29<br>APPROVED | Your money story<br><sub>`story:share.percent`</sub> | 52% *(a bare value; example values)* | label | Not on a captured screen; the values change with the account | — |  |
| S30<br>APPROVED | Alerts (laptop, phone); Your money story (laptop, phone); Words (laptop, phone)<br><sub>`story:share.partIn`</sub> | Money you put in | 0.7 | Nothing needs you: same<br>Brand-new: same | — |  |
| S31<br>APPROVED | Your money story (laptop, phone); Home (laptop); Word explanation<br><sub>`story:share.partEarned`</sub> | What it earned | label | Nothing needs you: same<br>Brand-new: not shown | — |  |
| S32<br>APPROVED | Your money story (laptop, phone)<br><sub>`story:share.chartTitle`</sub> | Your balance, in two parts | 0.5 | Nothing needs you: same<br>Brand-new: not shown | — |  |
| S33<br>APPROVED | Your money story (laptop, phone)<br><sub>`story:share.note`</sub> | What it earned is its return. It needs years to grow. | -0.6 | Nothing needs you: same<br>Brand-new: not shown | — |  |
| S34<br>APPROVED | Your money story (laptop, phone)<br><sub>`story:share.returnWord`</sub> | return | label | Nothing needs you: same<br>Brand-new: not shown | — |  |
| S35<br>APPROVED | Your money story (laptop, phone)<br><sub>`story:dip.high`</sub> | May 21: Your investments started to fall. | 2.9 | Nothing needs you: same<br>Brand-new: not shown | — |  |
| S36<br>APPROVED | Your money story (laptop, phone)<br><sub>`story:dip.low`</sub> | June 5: The fall hit its low. | -1.8 | Nothing needs you: same<br>Brand-new: not shown | — |  |
| S37<br>APPROVED | Your money story (laptop, phone)<br><sub>`story:dip.paused`</sub> | June 8: You paused auto-invest. | label | Nothing needs you: not shown<br>Brand-new: not shown | — |  |
| S38<br>APPROVED | Your money story (laptop, phone)<br><sub>`story:dip.backAbove`</sub> | June 15: Your balance was back above what you had put in. | 2.5 | Nothing needs you: same<br>Brand-new: not shown | — |  |
| S39<br>APPROVED | Your money story (phone)<br><sub>`story:dip.depositInvested`</sub> | July 1: Your deposit bought your mix. *(only in the Nothing needs you account)* | 2.9 | Nothing needs you: “July 1: Your deposit bought your mix.”<br>Brand-new: not shown | — |  |
| S40<br>APPROVED | Your money story (laptop, phone)<br><sub>`story:dip.depositCash`</sub> | July 1: Your deposit stayed as cash. *(and 1 more like it)* | 2.9 | Nothing needs you: not shown<br>Brand-new: not shown | — |  |
| S41<br>APPROVED | Your money story (laptop, phone)<br><sub>`story:dip.summary`</sub> | Your balance from April 15 to Sept. 18, with the dip and what came after. | 6.0 | Nothing needs you: same<br>Brand-new: not shown | — |  |
| S42<br>APPROVED | Home (laptop, phone); Investments (laptop, phone); Your money story (laptop, phone); Activity (laptop)<br><sub>`story:dip.colDate`</sub> | Date | label | Nothing needs you: same<br>Brand-new: same | — |  |
| S43<br>APPROVED | Home (laptop, phone); Your money story (laptop, phone); Words (laptop, phone); Word explanation<br><sub>`story:dip.colBalance`</sub> | Balance | label | Nothing needs you: same<br>Brand-new: same | — |  |
| S44<br>APPROVED | Home (laptop, phone); Your money story (laptop, phone); Word explanation<br><sub>`story:dip.colMoneyIn`</sub> | You put in | label | Nothing needs you: same<br>Brand-new: not shown | — |  |
| S45<br>APPROVED | Your money story (laptop, phone); Words (laptop, phone); Investments (laptop); Practice (after buying)<br><sub>`story:dip.colDiff`</sub> | Up or down | label | Nothing needs you: same<br>Brand-new: same | — |  |
| S46<br>APPROVED | Your money story (laptop, phone)<br><sub>`story:dip.chartTitle`</sub> | The dip and what came after | 0.5 | Nothing needs you: same<br>Brand-new: not shown | — |  |
| S47<br>APPROVED | Your money story (laptop, phone)<br><sub>`story:dip.showEvents`</sub> | Show events on the chart | 0.5 | Nothing needs you: same<br>Brand-new: not shown | — |  |
| S48<br>APPROVED | Your money story (laptop, phone)<br><sub>`story:dip.eventsLabel`</sub> | Events on the chart | 0.7 | Nothing needs you: same<br>Brand-new: not shown | — |  |
| S49<br>DRAFT | Your money story (laptop, phone)<br><sub>`story:dip.eventsOn`</sub> | A diamond marks each event, and the list below the chart names them. | 4.0 | Nothing needs you: same<br>Brand-new: not shown | — | New in Phase 5: the P302 reviewer found that the events toggle changed no sentence. |
| S50<br>DRAFT | Your money story<br><sub>`story:dip.eventsOff`</sub> | The chart shows your balance without the events. *(not on a captured screen; example values)* | 3.8 | Same words wherever it shows | — | New in Phase 5: the P302 reviewer found that the events toggle changed no sentence. |
| S51<br>APPROVED | Your money story (laptop, phone); Activity (laptop)<br><sub>`story:mix.filters.all`</sub> | All | label | Nothing needs you: same<br>Brand-new: not shown | — |  |
| S52<br>APPROVED | Your money story (laptop, phone); Home (laptop); Word explanation; Practice (after buying)<br><sub>`story:mix.filters.stocks`</sub> | Stocks | label | Nothing needs you: same<br>Brand-new: not shown | — |  |
| S53<br>APPROVED | Alerts (laptop, phone); Investments (laptop, phone); Your money story (laptop, phone); and 3 more screens<br><sub>`story:mix.filters.crypto`</sub> | Crypto | label | Nothing needs you: same<br>Brand-new: same | — |  |
| S54<br>APPROVED | Alerts (laptop, phone); Your money story (laptop, phone); Home (laptop); and 3 more screens<br><sub>`story:mix.filters.cash`</sub> | Cash | label | Nothing needs you: same<br>Brand-new: not shown | — |  |
| S55<br>APPROVED | Alerts (laptop, phone); Your money story (laptop, phone); Home (laptop); and 3 more screens<br><sub>`story:mix.cash`</sub> | Cash | label | Nothing needs you: same<br>Brand-new: not shown | — |  |
| S56<br>APPROVED | Your money story<br><sub>`story:mix.summaryOne`</sub> | Your $1,336.80 is split across 1 investment. *(not on a captured screen; example values)* | 7.4 | Not on a captured screen; the values change with the account | — |  |
| S57<br>APPROVED | Your money story<br><sub>`story:mix.summaryMany`</sub> | Your $1,336.80 is split across 2 investments. *(not on a captured screen; example values)* | 7.4 | Not on a captured screen; the values change with the account | — |  |
| S58<br>APPROVED | Your money story<br><sub>`story:mix.summaryOneCash`</sub> | Your $1,336.80 is split across 2 investment and cash. *(not on a captured screen; example values)* | 6.3 | Not on a captured screen; the values change with the account | — |  |
| S59<br>APPROVED | Your money story (laptop, phone)<br><sub>`story:mix.summaryManyCash`</sub> | Your $1,358.50 is split across 7 investments and cash. | 6.3 | Nothing needs you: “Your $1,536.68 is split across 7 investments and cash.”<br>Brand-new: not shown | — |  |
| S60<br>APPROVED | Your money story<br><sub>`story:mix.noStocks`</sub> | You do not own any stocks right now. *(not on a captured screen; example values)* | -0.7 | Same words wherever it shows | — |  |
| S61<br>APPROVED | Your money story<br><sub>`story:mix.noCrypto`</sub> | You do not own any crypto right now. *(not on a captured screen; example values)* | 0.8 | Same words wherever it shows | — |  |
| S62<br>APPROVED | Your money story<br><sub>`story:mix.stocksShare`</sub> | Stocks are $150 of your balance, or 52%. *(not on a captured screen; example values)* | 3.8 | Not on a captured screen; the values change with the account | — |  |
| S63<br>APPROVED | Your money story<br><sub>`story:mix.cryptoShare`</sub> | Crypto is $150 of your balance, or 52%. *(not on a captured screen; example values)* | 5.2 | Not on a captured screen; the values change with the account | — |  |
| S64<br>APPROVED | Your money story<br><sub>`story:mix.noCash`</sub> | You have no cash waiting right now. *(not on a captured screen; example values)* | 0.6 | Same words wherever it shows | — |  |
| S65<br>APPROVED | Your money story<br><sub>`story:mix.cashShare`</sub> | Cash is $150 of your balance, or 52%. *(not on a captured screen; example values)* | 3.8 | Not on a captured screen; the values change with the account | — |  |
| S66<br>APPROVED | Your money story (laptop, phone)<br><sub>`story:mix.colWhere`</sub> | Where | label | Nothing needs you: same<br>Brand-new: not shown | — |  |
| S67<br>APPROVED | Alerts (laptop, phone); Activity (laptop, phone); Investments (laptop, phone); and 3 more screens<br><sub>`story:mix.colAmount`</sub> | Amount | label | Nothing needs you: same<br>Brand-new: same | — |  |
| S68<br>APPROVED | Your money story (laptop, phone)<br><sub>`story:mix.colShare`</sub> | Share of balance | label | Nothing needs you: same<br>Brand-new: not shown | — |  |
| S69<br>APPROVED | Your money story<br><sub>`story:mix.percent`</sub> | 52% *(a bare value; example values)* | label | Not on a captured screen; the values change with the account | — |  |
| S70<br>APPROVED | Your money story (laptop, phone)<br><sub>`story:mix.claim`</sub> | Here is how your money is split today, as of the last prices. | 3.1 | Nothing needs you: same<br>Brand-new: not shown | — |  |
| S71<br>APPROVED | Your money story (laptop, phone)<br><sub>`story:mix.chartTitle`</sub> | Where your money is | 0.7 | Nothing needs you: same<br>Brand-new: not shown | — |  |
| S72<br>APPROVED | Your money story (laptop, phone)<br><sub>`story:mix.filterGroup`</sub> | Show | label | Nothing needs you: same<br>Brand-new: not shown | — |  |
| S73<br>APPROVED | Your money story (laptop, phone)<br><sub>`story:mix.rowsKey`</sub> | Each row shows the amount and its share of your balance. | 2.6 | Nothing needs you: same<br>Brand-new: not shown | — |  |
| S74<br>APPROVED | Your money story (laptop, phone); Home (laptop); Word explanation; Practice (after buying)<br><sub>`story:mix.rowNums`</sub> | $288.67 · 21% *(and 31 more like it)* | label | Nothing needs you: “$404.26 · 26%”<br>Brand-new: not shown | — |  |
| S75<br>APPROVED | Your money story (laptop)<br><sub>`story:mix.words`</sub> | Words: stocks, crypto, cash. | label | Nothing needs you: same<br>Brand-new: not shown | — |  |
| S76<br>APPROVED | Your money story (laptop)<br><sub>`story:mix.stocksWord`</sub> | stocks | label | Nothing needs you: same<br>Brand-new: not shown | — |  |
| S77<br>APPROVED | Home (phone); Your money story (laptop)<br><sub>`story:mix.cashWord`</sub> | cash | label | Nothing needs you: same<br>Brand-new: same | — |  |
| S78<br>APPROVED | Your money story (laptop)<br><sub>`story:mix.cryptoWord`</sub> | crypto | label | Nothing needs you: same<br>Brand-new: not shown | — |  |
| S79<br>APPROVED | Your money story<br><sub>`story:keepGoing.gotIt`</sub> | You got it. *(not on a captured screen; example values)* | label | Same words wherever it shows | — |  |
| S80<br>APPROVED | Your money story<br><sub>`story:keepGoing.theoGuess`</sub> | Theo puts in more each month, so he seems like the better guess. *(not on a captured screen; example values)* | 2.2 | Same words wherever it shows | — |  |
| S81<br>APPROVED | Your money story<br><sub>`story:keepGoing.noGuess`</sub> | Here is how it turns out. *(not on a captured screen; example values)* | -1.4 | Same words wherever it shows | — |  |
| S82<br>APPROVED | Your money story (laptop, phone)<br><sub>`story:keepGoing.nia`</sub> | Nia | label | Nothing needs you: same<br>Brand-new: same | — |  |
| S83<br>APPROVED | Your money story (laptop, phone)<br><sub>`story:keepGoing.theo`</sub> | Theo | label | Nothing needs you: same<br>Brand-new: same | — |  |
| S84<br>APPROVED | Your money story<br><sub>`story:keepGoing.day`</sub> | Age 30: Nia has $242,251. $186,213 *(not on a captured screen; example values)* | label | Not on a captured screen; the values change with the account | — |  |
| S85<br>APPROVED | Your money story<br><sub>`story:keepGoing.theoHas`</sub> | Theo has $150. *(not on a captured screen; example values)* | label | Not on a captured screen; the values change with the account | — |  |
| S86<br>APPROVED | Your money story<br><sub>`story:keepGoing.theoNotYet`</sub> | Theo has not started yet. *(not on a captured screen; example values)* | -1.8 | Same words wherever it shows | — |  |
| S87<br>APPROVED | Your money story<br><sub>`story:keepGoing.notStarted`</sub> | Not started *(not on a captured screen; example values)* | label | Same words wherever it shows | — |  |
| S88<br>APPROVED | Your money story<br><sub>`story:keepGoing.colAge`</sub> | Age *(not on a captured screen; example values)* | label | Same words wherever it shows | — |  |
| S89<br>APPROVED | Your money story (laptop, phone)<br><sub>`story:keepGoing.meet`</sub> | Meet two friends, Nia and Theo. Nia starts at 22 and puts in $100 a month. Theo waits until 32 and puts in $150 a month. | 1.9 | Nothing needs you: same<br>Brand-new: same | — |  |
| S90<br>APPROVED | Your money story (laptop, phone)<br><sub>`story:keepGoing.guessHeading`</sub> | Make a guess: who has more at 65? | 0.5 | Nothing needs you: same<br>Brand-new: same | — |  |
| S91<br>APPROVED | Your money story (laptop, phone)<br><sub>`story:keepGoing.guessLabel`</sub> | Your guess | label | Nothing needs you: same<br>Brand-new: same | — |  |
| S92<br>APPROVED | Your money story<br><sub>`story:keepGoing.result`</sub> | {reply} At 30, Nia has $242,251. Theo has $186,213. *(not on a captured screen; example values)* | 1.9 | Not on a captured screen; the values change with the account | — |  |
| S93<br>APPROVED | Your money story<br><sub>`story:keepGoing.friendsTitle`</sub> | Nia and Theo from {startAge} to 65 *(not on a captured screen; example values)* | 0.6 | Not on a captured screen; the values change with the account | — |  |
| S94<br>APPROVED | Your money story<br><sub>`story:keepGoing.whyHeading`</sub> | Why Nia ends ahead *(not on a captured screen; example values)* | 0.7 | Same words wherever it shows | — |  |
| S95<br>APPROVED | Your money story<br><sub>`story:keepGoing.why`</sub> | Nia put in $242,251. Theo put in $186,213. {claim} That is growth on growth: your money earns money, and that money earns more. *(not on a captured screen; example values)* | 1.8 | Not on a captured screen; the values change with the account | — |  |
| S96<br>APPROVED | Your money story<br><sub>`story:keepGoing.growthWord`</sub> | growth on growth *(not on a captured screen; example values)* | label | Same words wherever it shows | — |  |
| S97<br>APPROVED | Your money story<br><sub>`story:keepGoing.everyYear`</sub> | Every year counts *(not on a captured screen; example values)* | label | Same words wherever it shows | — |  |
| S98<br>APPROVED | Your money story<br><sub>`story:keepGoing.startAge`</sub> | Start age *(not on a captured screen; example values)* | label | Same words wherever it shows | — |  |
| S99<br>APPROVED | Your money story<br><sub>`story:keepGoing.startAt`</sub> | Start at 30 *(not on a captured screen; example values)* | label | Not on a captured screen; the values change with the account | — |  |
| S100<br>APPROVED | Your money story<br><sub>`story:keepGoing.startResult`</sub> | Start at 30. At 65 you would have $246.92. You would put in $9,600. *(not on a captured screen; example values)* | 1.4 | Not on a captured screen; the values change with the account | — |  |
| S101<br>APPROVED | Your money story<br><sub>`story:keepGoing.startLate`</sub> |  Starting at 30 still helps. It just has fewer years to grow. *(not on a captured screen; example values)* | 1.5 | Not on a captured screen; the values change with the account | — |  |
| S102<br>APPROVED | Your money story<br><sub>`story:keepGoing.catchUpHeading`</sub> | Can Theo catch up? *(not on a captured screen; example values)* | -2.2 | Same words wherever it shows | — |  |
| S103<br>APPROVED | Your money story<br><sub>`story:keepGoing.theoMonthly`</sub> | Theo each month *(not on a captured screen; example values)* | label | Same words wherever it shows | — |  |
| S104<br>APPROVED | Your money story (laptop, phone)<br><sub>`story:keepGoing.perMonth`</sub> | $100 a month | label | Nothing needs you: same<br>Brand-new: same | — |  |
| S105<br>APPROVED | Your money story<br><sub>`story:keepGoing.passesMark`</sub> | Passes Nia: $150 *(not on a captured screen; example values)* | label | Not on a captured screen; the values change with the account | — |  |
| S106<br>APPROVED | Your money story<br><sub>`story:keepGoing.catchUp`</sub> | At $150 a month, Theo ends with $186,213. Nia ends with $242,251. *(not on a captured screen; example values)* | 1.5 | Not on a captured screen; the values change with the account | — |  |
| S107<br>APPROVED | Your money story<br><sub>`story:keepGoing.passes`</sub> |  At $150 a month, Theo passes Nia. *(not on a captured screen; example values)* | 0.6 | Not on a captured screen; the values change with the account | — |  |
| S108<br>APPROVED | Your money story<br><sub>`story:keepGoing.behind`</sub> |  Theo is still behind. *(not on a captured screen; example values)* | 0.7 | Same words wherever it shows | — |  |
| S109<br>APPROVED | Your money story<br><sub>`story:keepGoing.catchUpNote`</sub> | {claim} That is almost twice what Nia puts in. *(not on a captured screen; example values)* | 1.0 | Not on a captured screen; the values change with the account | — |  |
| S110<br>APPROVED | Your money story<br><sub>`story:keepGoing.bumpyHeading`</sub> | Real life is bumpy *(not on a captured screen; example values)* | 0.7 | Same words wherever it shows | — |  |
| S111<br>APPROVED | Your money story<br><sub>`story:keepGoing.growth`</sub> | Growth *(not on a captured screen; example values)* | label | Same words wherever it shows | — |  |
| S112<br>APPROVED | Your money story<br><sub>`story:keepGoing.smooth`</sub> | Smooth *(not on a captured screen; example values)* | label | Same words wherever it shows | — |  |
| S113<br>APPROVED | Your money story<br><sub>`story:keepGoing.bumpy`</sub> | Bumpy *(not on a captured screen; example values)* | label | Same words wherever it shows | — |  |
| S114<br>APPROVED | Your money story<br><sub>`story:keepGoing.smoothTitle`</sub> | Smooth years *(not on a captured screen; example values)* | label | Same words wherever it shows | — |  |
| S115<br>APPROVED | Your money story<br><sub>`story:keepGoing.bumpyTitle`</sub> | Bumpy years *(not on a captured screen; example values)* | label | Same words wherever it shows | — |  |
| S116<br>APPROVED | Your money story<br><sub>`story:keepGoing.shapeSummary`</sub> | {note} Nia ends with $242,251. Theo ends with $186,213. *(not on a captured screen; example values)* | 0.6 | Not on a captured screen; the values change with the account | — |  |
| S117<br>APPROVED | Your money story<br><sub>`story:keepGoing.yourTurn`</sub> | Your turn *(not on a captured screen; example values)* | label | Same words wherever it shows | — |  |
| S118<br>APPROVED | Your money story<br><sub>`story:keepGoing.eachMonth`</sub> | Each month *(not on a captured screen; example values)* | label | Same words wherever it shows | — |  |
| S119<br>APPROVED | Your money story<br><sub>`story:keepGoing.yourResult`</sub> | Start at 30 with $150 a month. At 65 you would have $246.92. *(not on a captured screen; example values)* | 2.4 | Not on a captured screen; the values change with the account | — |  |
| S120<br>DRAFT | Your money story (laptop, phone)<br><sub>`story:keepGoing.showAnswer`</sub> | Show the answer | label | Nothing needs you: same<br>Brand-new: same | — | New in Phase 5: the P302 reviewer found that the answer showed before any guess; the guess stays optional through this button. |
| S121<br>DRAFT | Your money story<br><sub>`story:keepGoing.splitTitle`</sub> | What Nia put in, and what it grew into *(not on a captured screen; example values)* | 1.0 | Same words wherever it shows | — | New in Phase 5: the P302 reviewer found that 5c had no chart splitting Nia's money into put in and growth. |
| S122<br>DRAFT | Your money story<br><sub>`story:keepGoing.niaMoney`</sub> | Nia's money *(not on a captured screen; example values)* | label | Same words wherever it shows | — | New in Phase 5: the P302 reviewer found the missing 5c chart; this is its line. |
| S123<br>DRAFT | Your money story<br><sub>`story:keepGoing.niaPutIn`</sub> | What Nia put in *(not on a captured screen; example values)* | -2.2 | Same words wherever it shows | — | New in Phase 5: the P302 reviewer found the missing 5c chart; this is its line. |
| S124<br>DRAFT | Your money story<br><sub>`story:keepGoing.daySplit`</sub> | Age 30: Nia has $246.92. She put in $9,600. *(not on a captured screen; example values)* | label | Not on a captured screen; the values change with the account | — | New in Phase 5: the P302 reviewer found the missing 5c chart; this is its read-out. |
| S125<br>DRAFT | Your money story<br><sub>`story:keepGoing.colMoney`</sub> | Money *(not on a captured screen; example values)* | label | Same words wherever it shows | — | New in Phase 5: the P302 reviewer found the missing 5c, 5d and 5g charts; this is a table column. |
| S126<br>DRAFT | Your money story<br><sub>`story:keepGoing.colPutIn`</sub> | Put in *(not on a captured screen; example values)* | label | Same words wherever it shows | — | New in Phase 5: the P302 reviewer found the missing 5c chart; this is a table column. |
| S127<br>DRAFT | Your money story<br><sub>`story:keepGoing.oneTitle`</sub> | One saver at $150 a month, from 30 to 65 *(not on a captured screen; example values)* | 4.8 | Not on a captured screen; the values change with the account | — | New in Phase 5: the P302 reviewer found that 5d had no chart. |
| S128<br>DRAFT | Your money story<br><sub>`story:keepGoing.saver`</sub> | The saver *(not on a captured screen; example values)* | label | Same words wherever it shows | — | New in Phase 5: the P302 reviewer found that 5d had no chart; this is its line. |
| S129<br>DRAFT | Your money story<br><sub>`story:keepGoing.dayOne`</sub> | Age 30: $246.92. *(not on a captured screen; example values)* | label | Not on a captured screen; the values change with the account | — | New in Phase 5: the P302 reviewer found that 5d and 5g had no charts; this is their read-out. |
| S130<br>DRAFT | Your money story<br><sub>`story:keepGoing.yourTitle`</sub> | Your money from 30 to 65 *(not on a captured screen; example values)* | 4.5 | Not on a captured screen; the values change with the account | — | New in Phase 5: the P302 reviewer found that 5g had no chart. |
| S131<br>DRAFT | Your money story<br><sub>`story:keepGoing.you`</sub> | You *(not on a captured screen; example values)* | label | Same words wherever it shows | — | New in Phase 5: the P302 reviewer found that 5g had no chart; this is its line. |
| S132<br>DRAFT | Your money story<br><sub>`story:keepGoing.catchTitle`</sub> | Nia, and Theo at $150 a month *(not on a captured screen; example values)* | 0.6 | Not on a captured screen; the values change with the account | — | New in Phase 5: the P302 reviewer found that 5e had no chart (and two charts would share one title). |
| S133<br>APPROVED | Your money story (laptop, phone)<br><sub>`story:practice.claim`</sub> | Practice lets you try a mix with practice money. Nothing you do there touches your account. | 3.0 | Nothing needs you: same<br>Brand-new: same | — |  |
| S134<br>APPROVED | Your money story (laptop, phone)<br><sub>`story:practice.go`</sub> | Go to Practice | label | Nothing needs you: same<br>Brand-new: same | — |  |
| S135<br>APPROVED | Your money story<br><sub>`story:slider.label`</sub> | Start age: Start at 30 *(a bare value; example values)* | label | Not on a captured screen; the values change with the account | — |  |
| S136<br>DRAFT | Your money story (laptop, phone)<br><sub>`story:closing.title`</sub> | What to take away | 0.7 | Nothing needs you: same<br>Brand-new: same | — | New in Phase 5: the P302 reviewer found that the story had no closing takeaway. |
| S137<br>DRAFT | Your money story (laptop, phone)<br><sub>`story:closing.sources`</sub> | Where the numbers come from | 0.5 | Nothing needs you: same<br>Brand-new: same | — | New in Phase 5: the P302 reviewer found that the closing had no sources. |
| S138<br>APPROVED | Your money story (laptop, phone)<br><sub>`data:rosaStory.pointOfView`</sub> | Right now, almost all of your balance is money you put in. Growth needs years, so starting early and staying steady matter more than picking the perfect moment. | 6.3 | Nothing needs you: same<br>Brand-new: “Growth needs years. Starting early and staying steady matter more than picking the perfect moment.” | — |  |
| S139<br>APPROVED | Your money story (laptop, phone)<br><sub>`data:rosaStory.since-march`</sub> | You opened your account on March 2 with $500. Since then you have put in $1,250. On Sept. 18 your balance was $1,358.50. | 3.3 | Nothing needs you: “You opened your account on March 2 with $500. Since then you have put in $1,400. On Sept. 18 your balance was $1,536.68.”<br>Brand-new: not shown (short story) | — |  |
| S140<br>APPROVED | Your money story (laptop, phone)<br><sub>`data:rosaStory.deposits-share`</sub> | About 92% of your balance is money you put in. The other $108.50 is what it earned. | 3.7 | Nothing needs you: “About 91% of your balance is money you put in. The other $136.68 is what it earned.”<br>Brand-new: not shown (short story) | — |  |
| S141<br>APPROVED | Your money story (laptop, phone)<br><sub>`data:rosaStory.dip`</sub> | From May 21 to June 5, falling prices took $80.24 off your balance. That is a drop of 9.5%. | 3.6 | Nothing needs you: same<br>Brand-new: not shown (short story) | — |  |
| S142<br>APPROVED | Your money story (laptop, phone)<br><sub>`data:rosaStory.at-low`</sub> | On June 5, your balance was $915.77. That was $34.23 below the $950 you had put in. | 3.7 | Nothing needs you: same<br>Brand-new: not shown (short story) | — |  |
| S143<br>APPROVED | Your money story (laptop, phone)<br><sub>`data:rosaStory.pause`</sub> | You paused auto-invest the next trading day, June 8. | 6.3 | Nothing needs you: not shown<br>Brand-new: not shown (short story) | — |  |
| S144<br>APPROVED | Your money story (laptop, phone)<br><sub>`data:rosaStory.back-above`</sub> | By June 15, your balance was back above what you had put in. | 4.0 | Nothing needs you: same<br>Brand-new: not shown (short story) | — |  |
| S145<br>APPROVED | Your money story (laptop, phone)<br><sub>`data:rosaStory.cash-after`</sub> | After that, your July 1 and Aug. 3 deposits stayed as cash. | 6.8 | Nothing needs you: not shown<br>Brand-new: not shown (short story) | — |  |
| S146<br>APPROVED | Your money story (laptop, phone)<br><sub>`data:rosaStory.up-now`</sub> | On Sept. 18, you were up $108.50. | label | Nothing needs you: “On Sept. 18, you were up $136.68.”<br>Brand-new: not shown (short story) | — |  |
| S147<br>APPROVED | Your money story (phone)<br><sub>`data:rosaStory.kept-buying`</sub> | Auto-invest stayed on. Your July 1, Aug. 3 and Sept. 1 deposits bought your mix the day they arrived. *(the “Nothing needs you” account only)* | 6.1 | Normal: not shown<br>Brand-new: not shown | — |  |
| S148<br>APPROVED | Your money story (laptop, phone)<br><sub>`data:story.claims.early-ends-ahead`</sub> | Nia ends with more money than Theo. | 0.6 | Nothing needs you: same<br>Brand-new: same | — |  |
| S149<br>APPROVED | Your money story, chapter 5<br><sub>`data:story.claims.early-puts-in-less`</sub> | Nia puts in less money than Theo. *(not on a captured screen; example values)* | 0.6 | Same words wherever it shows | — |  |
| S150<br>APPROVED | Your money story, chapter 5<br><sub>`data:story.claims.early-earned-share`</sub> | Most of Nia's money at 65 came from growth, not from what she put in. *(not on a captured screen; example values)* | 3.6 | Same words wherever it shows | — |  |
| S151<br>APPROVED | Your money story, chapter 5<br><sub>`data:story.claims.catch-up-costs-more`</sub> | To catch up, Theo would need about $196 a month. *(not on a captured screen; example values)* | 2.5 | Same words wherever it shows | — |  |
| S152<br>APPROVED | Your money story (laptop, phone)<br><sub>`data:story.claims.early-ahead-when-bumpy`</sub> | Even when the years go up and down, Nia still ends ahead. | 2.9 | Nothing needs you: same<br>Brand-new: same | — |  |
| S153<br>APPROVED | Your money story (laptop, phone)<br><sub>`data:story.assumptions.note`</sub> | An example rate of 6% a year. Real markets go up and down, and nobody can promise a rate. | 4.3 | Nothing needs you: same<br>Brand-new: same | — |  |
| S154<br>APPROVED | Your money story, chapter 5<br><sub>`data:story.bumpy.note`</sub> | Same overall growth as the smooth line: 6% a year. The order of good and bad years changes the ending. *(not on a captured screen; example values)* | 3.1 | Same words wherever it shows | — |  |
...
| P56<br>APPROVED | Words (laptop, phone); Practice (after buying)<br><sub>`practice:ownedShares`</sub> | 0.2975 shares *(and 2 more like it)* | label | Nothing needs you: same<br>Brand-new: same | — |  |
...
| W11<br>APPROVED | Investments (laptop, phone); Your money story (laptop, phone); Words (laptop, phone)<br><sub>`learn:newTab`</sub> | (opens in a new tab) | 0.5 | Nothing needs you: same<br>Brand-new: same | — |  |
...
| W20<br>APPROVED | Activity (laptop, phone); Words (laptop, phone)<br><sub>`data:glossary.deposit.term`</sub> | Deposit | label | Same in every scenario | — |  |
...
| W39<br>APPROVED | Alerts (laptop, phone); Activity (laptop, phone); Your money story (phone); and 3 more screens<br><sub>`data:glossary.cash.term`</sub> | Cash in your account | 0.7 | Same in every scenario | — |  |
...
| W83<br>APPROVED | Your money story (laptop, phone); Words (laptop, phone)<br><sub>`data:glossary.return.term`</sub> | Return | label | Same in every scenario | — |  |
...
| W87<br>APPROVED | Activity (laptop, phone); Investments (phone); Words (laptop, phone)<br><sub>`data:glossary.dividend.term`</sub> | Dividend | label | Same in every scenario | — |  |
...
| W91<br>DRAFT | Investments (phone); Words (laptop, phone)<br><sub>`data:glossary.ex-dividend-date.term`</sub> | Ex-dividend date | label | Same in every scenario | — | New in Phase 5: the P301 reviewer found that "ex-dividend date" had no explanation; this is its new glossary word. |
| W92<br>DRAFT | Words (laptop, phone)<br><sub>`data:glossary.ex-dividend-date.short`</sub> | The date that decides who gets the next dividend. | 3.7 | Same in every scenario | — | New in Phase 5: the P301 reviewer found that "ex-dividend date" had no explanation; this is its new glossary word. |
| W93<br>DRAFT | Words, and every explanation of this word<br><sub>`data:glossary.ex-dividend-date.detail`</sub> | A company sets this date for each dividend it pays. If you own a share before that date, you get the payment. If you buy on or after it, you wait for the next one. *(not on a captured screen; example values)* | 3.1 | Same in every scenario | — | New in Phase 5: the P301 reviewer found that "ex-dividend date" had no explanation; this is its new glossary word. |
| W94<br>DRAFT | Words, and every explanation of this word<br><sub>`data:glossary.ex-dividend-date.example`</sub> | Say the date is Nov. 10. You must own the share by Nov. 9 to get that payment. *(not on a captured screen; example values)* | 1.7 | Same in every scenario | — | New in Phase 5: the P301 reviewer found that "ex-dividend date" had no explanation; this is its new glossary word. |
| W95<br>APPROVED | Investments (laptop, phone); Your money story (phone); Words (laptop, phone)<br><sub>`data:glossary.stock.term`</sub> | Stock | label | Same in every scenario | — |  |
| W96<br>APPROVED | Words, and every explanation of this word<br><sub>`data:glossary.stock.alsoCalled`</sub> | shares of a company, equity *(not on a captured screen; example values)* | 7.6 | Same in every scenario | — |  |
| W97<br>APPROVED | Words (laptop, phone)<br><sub>`data:glossary.stock.short`</sub> | A small piece of a company that you can own. | 2.5 | Same in every scenario | — |  |
| W98<br>APPROVED | Words, and every explanation of this word<br><sub>`data:glossary.stock.detail`</sub> | When the company does well, its stock can grow. It can also drop fast. That is why stocks have ups and downs. *(not on a captured screen; example values)* | 0.7 | Same in every scenario | — |  |
| W99<br>APPROVED | Words, and every explanation of this word<br><sub>`data:glossary.stock.example`</sub> | Owning one share of Apple means you own a tiny piece of Apple. *(not on a captured screen; example values)* | 4.9 | Same in every scenario | — |  |
| W100<br>APPROVED | Alerts (laptop, phone); Investments (laptop, phone); Your money story (laptop, phone); and 3 more screens<br><sub>`data:glossary.crypto.term`</sub> | Crypto | label | Same in every scenario | — |  |
| W101<br>APPROVED | Words, and every explanation of this word<br><sub>`data:glossary.crypto.alsoCalled`</sub> | cryptocurrency, digital asset *(not on a captured screen; example values)* | label | Same in every scenario | — |  |
| W102<br>APPROVED | Alerts (laptop, phone); Words (laptop, phone)<br><sub>`data:glossary.crypto.short`</sub> | Digital money that no government or bank runs. | 6.7 | Same in every scenario | — |  |
| W103<br>APPROVED | Words, and every explanation of this word<br><sub>`data:glossary.crypto.detail`</sub> | Crypto lives on a network of computers. Its price can swing a lot in a single day. It trades every day, even on weekends. *(not on a captured screen; example values)* | 3.8 | Same in every scenario | — |  |
| W104<br>APPROVED | Words, and every explanation of this word<br><sub>`data:glossary.crypto.example`</sub> | Bitcoin and Ethereum are two kinds of crypto. *(not on a captured screen; example values)* | 5.2 | Same in every scenario | — |  |
| W105<br>APPROVED | Investments (laptop, phone); Words (laptop, phone)<br><sub>`data:glossary.bitcoin.term`</sub> | Bitcoin | label | Same in every scenario | — |  |
| W106<br>APPROVED | Home (laptop, phone); Investments (laptop, phone); Your money story (laptop, phone); and 3 more screens<br><sub>`data:glossary.bitcoin.alsoCalled`</sub> | BTC | label | Same in every scenario | — |  |
| W107<br>APPROVED | Words (laptop, phone)<br><sub>`data:glossary.bitcoin.short`</sub> | The first and best-known crypto. | 2.9 | Same in every scenario | — |  |
| W108<br>APPROVED | Words, and every explanation of this word<br><sub>`data:glossary.bitcoin.detail`</sub> | Bitcoin started in 2009. No company runs it. You can own a tiny part of one Bitcoin. *(not on a captured screen; example values)* | 2.6 | Same in every scenario | — |  |
| W109<br>APPROVED | Words, and every explanation of this word<br><sub>`data:glossary.bitcoin.example`</sub> | $18 can buy a small part of one Bitcoin. *(not on a captured screen; example values)* | 2.3 | Same in every scenario | — |  |
| W110<br>APPROVED | Alerts (laptop, phone); Investments (laptop, phone); Words (laptop, phone)<br><sub>`data:glossary.sipc-protection.term`</sub> | SIPC protection | label | Same in every scenario | — |  |
| W111<br>APPROVED | Words, and every explanation of this word<br><sub>`data:glossary.sipc-protection.alsoCalled`</sub> | SIPC coverage *(not on a captured screen; example values)* | label | Same in every scenario | — |  |
| W112<br>APPROVED | Alerts (laptop, phone); Words (laptop, phone)<br><sub>`data:glossary.sipc-protection.short`</sub> | Protection for stocks and cash at a member brokerage that fails. | 5.9 | Same in every scenario | — |  |
| W113<br>APPROVED | Alerts (laptop, phone); Investments (laptop, phone)<br><sub>`data:glossary.sipc-protection.detail`</sub> | SIPC protection covers stocks and cash at a member brokerage if the brokerage fails. It doesn't cover crypto, such as Bitcoin or Ethereum. It never covers a drop in price. | 6.0 | Same in every scenario | — |  |
| W114<br>APPROVED | Words, and every explanation of this word<br><sub>`data:glossary.sipc-protection.example`</sub> | If a member brokerage closed and shares went missing, SIPC would work to get them back to their owners. *(not on a captured screen; example values)* | 6.7 | Same in every scenario | — |  |
| W115<br>APPROVED | Words (laptop, phone); Home (laptop); Word explanation<br><sub>`data:glossary.your-mix.term`</sub> | Your mix | label | Same in every scenario | — |  |
| W116<br>APPROVED | Words, and every explanation of this word<br><sub>`data:glossary.your-mix.alsoCalled`</sub> | asset allocation *(not on a captured screen; example values)* | label | Same in every scenario | — |  |
| W117<br>APPROVED | Words (laptop, phone)<br><sub>`data:glossary.your-mix.short`</sub> | How your money is split between stocks, crypto and cash. | 3.7 | Same in every scenario | — |  |
| W118<br>APPROVED | Words, and every explanation of this word<br><sub>`data:glossary.your-mix.detail`</sub> | Each part moves in its own way. Crypto usually jumps around more than stocks. Cash does not move with the market. You pick the split. *(not on a captured screen; example values)* | 1.0 | Same in every scenario | — |  |
| W119<br>APPROVED | Words, and every explanation of this word<br><sub>`data:glossary.your-mix.example`</sub> | A mix of 80% stocks and 20% crypto. *(not on a captured screen; example values)* | 3.8 | Same in every scenario | — |  |
| W120<br>APPROVED | Words (laptop, phone)<br><sub>`data:glossary.spreading-out.term`</sub> | Spreading out | label | Same in every scenario | — |  |
| W121<br>APPROVED | Words, and every explanation of this word<br><sub>`data:glossary.spreading-out.alsoCalled`</sub> | diversification *(not on a captured screen; example values)* | label | Same in every scenario | — |  |
| W122<br>APPROVED | Words (laptop, phone)<br><sub>`data:glossary.spreading-out.short`</sub> | Owning many different things so one bad one hurts you less. | 4.8 | Same in every scenario | — |  |
| W123<br>APPROVED | Words, and every explanation of this word<br><sub>`data:glossary.spreading-out.detail`</sub> | If one company has a bad year, the others can help balance it out. *(not on a captured screen; example values)* | 5.0 | Same in every scenario | — |  |
| W124<br>APPROVED | Words, and every explanation of this word<br><sub>`data:glossary.spreading-out.example`</sub> | Owning five companies instead of just one. *(not on a captured screen; example values)* | 5.7 | Same in every scenario | — |  |
| W125<br>APPROVED | Home (phone); Investments (laptop, phone); Words (laptop, phone)<br><sub>`data:glossary.ups-and-downs.term`</sub> | Ups and downs | label | Same in every scenario | — |  |
| W126<br>APPROVED | Words (laptop, phone)<br><sub>`data:glossary.ups-and-downs.alsoCalled`</sub> | risk level, volatility | label | Same in every scenario | — |  |
| W127<br>APPROVED | Home (phone); Words (laptop, phone)<br><sub>`data:glossary.ups-and-downs.short`</sub> | How much an investment's price tends to jump around. | 3.7 | Same in every scenario | — |  |
| W128<br>APPROVED | Words (laptop, phone)<br><sub>`data:glossary.ups-and-downs.detail`</sub> | We rate each one from 1, calm, to 5, bumpy, using how much its price moved each day over the past year. Bumpy ones can grow more over time, but they can also fall more on a bad day. | 6.2 | Same in every scenario | — |  |
| W129<br>APPROVED | Words (laptop, phone)<br><sub>`data:glossary.ups-and-downs.example`</sub> | Costco is a 1. Solana is a 5. | label | Same in every scenario | — |  |
| W130<br>APPROVED | Your money story (laptop, phone); Words (laptop, phone)<br><sub>`data:glossary.compound-growth.term`</sub> | Growth on growth | label | Same in every scenario | — |  |
| W131<br>APPROVED | Words, and every explanation of this word<br><sub>`data:glossary.compound-growth.alsoCalled`</sub> | compound growth, compounding *(not on a captured screen; example values)* | label | Same in every scenario | — |  |
| W132<br>APPROVED | Words (laptop, phone)<br><sub>`data:glossary.compound-growth.short`</sub> | When your money earns money, and then that new money earns money too. | 4.9 | Same in every scenario | — |  |
| W133<br>APPROVED | Words, and every explanation of this word<br><sub>`data:glossary.compound-growth.detail`</sub> | It starts small and speeds up over time, like a snowball rolling downhill. The more years it has, the bigger it gets. *(not on a captured screen; example values)* | 3.2 | Same in every scenario | — |  |
| W134<br>APPROVED | Words, and every explanation of this word<br><sub>`data:glossary.compound-growth.example`</sub> | $100 that grows 6% becomes $106. The next year, the 6% is on $106, not $100. *(not on a captured screen; example values)* | 4.5 | Same in every scenario | — |  |
| W135<br>APPROVED | Activity (laptop, phone); Words (laptop, phone)<br><sub>`data:glossary.settlement.term`</sub> | Settling | label | Same in every scenario | — |  |
| W136<br>APPROVED | Words, and every explanation of this word<br><sub>`data:glossary.settlement.alsoCalled`</sub> | settlement, T+1 *(not on a captured screen; example values)* | label | Same in every scenario | — |  |
| W137<br>APPROVED | Activity (laptop, phone); Words (laptop, phone)<br><sub>`data:glossary.settlement.short`</sub> | The short wait after you buy or sell before the trade is final. | 4.0 | Same in every scenario | — |  |
| W138<br>APPROVED | Words, and every explanation of this word<br><sub>`data:glossary.settlement.detail`</sub> | In the U.S., most trades are final one business day later. Until then, the trade shows as settling. *(not on a captured screen; example values)* | 3.7 | Same in every scenario | — |  |
| W139<br>APPROVED | Words, and every explanation of this word<br><sub>`data:glossary.settlement.example`</sub> | You buy on Monday. It is final on Tuesday. *(not on a captured screen; example values)* | 1.9 | Same in every scenario | — |  |
| W140<br>APPROVED | Alerts (laptop, phone); Words (laptop, phone)<br><sub>`data:glossary.goal-pace.term`</sub> | On pace | label | Same in every scenario | — |  |
| W141<br>APPROVED | Words, and every explanation of this word<br><sub>`data:glossary.goal-pace.alsoCalled`</sub> | goal pace *(not on a captured screen; example values)* | label | Same in every scenario | — |  |
| W142<br>APPROVED | Alerts (laptop, phone); Words (laptop, phone)<br><sub>`data:glossary.goal-pace.short`</sub> | Whether your deposits are keeping up with your plan. | 5.0 | Same in every scenario | — |  |
| W143<br>APPROVED | Words, and every explanation of this word<br><sub>`data:glossary.goal-pace.detail`</sub> | It only looks at the money you put in. It does not change when the market goes up or down. *(not on a captured screen; example values)* | 1.9 | Same in every scenario | — |  |
| W144<br>APPROVED | Words, and every explanation of this word<br><sub>`data:glossary.goal-pace.example`</sub> | You planned to put in $1,400 by now and put in $1,250. You are $150 behind. *(not on a captured screen; example values)* | 2.3 | Same in every scenario | — |  |
| W145<br>APPROVED | Home (laptop, phone); Alerts (laptop, phone); Activity (laptop, phone); and 11 more screens<br><sub>`data:glossary.practice-mode.term`</sub> | Practice | label | Same in every scenario | — |  |
| W146<br>APPROVED | Words, and every explanation of this word<br><sub>`data:glossary.practice-mode.alsoCalled`</sub> | practice mode, pretend money *(not on a captured screen; example values)* | 6.6 | Same in every scenario | — |  |
| W147<br>APPROVED | Words (laptop, phone)<br><sub>`data:glossary.practice-mode.short`</sub> | Practice money for trying things before you do them for real. | 3.7 | Same in every scenario | — |  |
| W148<br>APPROVED | Words, and every explanation of this word<br><sub>`data:glossary.practice-mode.detail`</sub> | You start with $1,000 in practice money. Nothing you do here touches your account, and you can start over at any time. *(not on a captured screen; example values)* | 3.7 | Same in every scenario | — |  |
| W149<br>APPROVED | Words, and every explanation of this word<br><sub>`data:glossary.practice-mode.example`</sub> | Buy a stock with practice money and see how it would have moved. *(not on a captured screen; example values)* | 3.1 | Same in every scenario | — |  |
| W150<br>APPROVED | Home (laptop, phone); Your money story (laptop, phone); Words (laptop, phone); Word explanation<br><sub>`data:glossary.the-market.term`</sub> | The market | label | Same in every scenario | — |  |
| W151<br>APPROVED | Words, and every explanation of this word<br><sub>`data:glossary.the-market.alsoCalled`</sub> | stock market *(not on a captured screen; example values)* | label | Same in every scenario | — |  |
| W152<br>APPROVED | Words (laptop, phone)<br><sub>`data:glossary.the-market.short`</sub> | All the people buying and selling investments. | 7.4 | Same in every scenario | — |  |
| W153<br>APPROVED | Words, and every explanation of this word<br><sub>`data:glossary.the-market.detail`</sub> | When more people want to buy, prices go up. When more people want to sell, prices go down. The stock market is open on weekdays, but not on some holidays. Crypto trades every day. *(not on a captured screen; example values)* | 3.0 | Same in every scenario | — |  |
| W154<br>APPROVED | Words, and every explanation of this word<br><sub>`data:glossary.the-market.example`</sub> | Prices can change every minute while the market is open. *(not on a captured screen; example values)* | 7.2 | Same in every scenario | — |  |
...
| C3<br>APPROVED | Home (laptop, phone); Investments (laptop, phone); Your money story (laptop, phone); Practice (laptop, phone)<br><sub>`shared:chart.asTable`</sub> | Balance since March, as a table *(and 8 more like it)* | 2.5 | Nothing needs you: same<br>Brand-new: same | — |  |
...
| C5<br>APPROVED | Investments (laptop, phone); Practice (after buying)<br><sub>`shared:chart.readHintSeries`</sub> | Move across the chart, tap it, or use the arrow keys to read it. | 3.4 | Nothing needs you: same<br>Brand-new: same | — |  |
...
| C7<br>APPROVED | Investments (laptop, phone); Practice (after buying)<br><sub>`shared:chart.keyboardSeries`</sub> | Price over time. Use the left and right arrow keys to read it. *(and 1 more like it)* | -0.6 | Nothing needs you: same<br>Brand-new: same | — |  |
...
| C17<br>APPROVED | Your money story (laptop, phone); Home (laptop); Word explanation<br><sub>`shared:ranges.3m.label`</sub> | 3 months | label | Nothing needs you: same<br>Brand-new: not shown | — |  |
| C18<br>APPROVED | Your money story (laptop, phone); Home (laptop); Word explanation<br><sub>`shared:ranges.all.label`</sub> | Since March | label | Nothing needs you: same<br>Brand-new: not shown | — |  |
...
| E2<br>APPROVED | Home (phone); Alerts (phone); Activity (phone); and 2 more screens<br><sub>`shared:wordChips.title`</sub> | Words on this screen | -2.2 | Nothing needs you: same<br>Brand-new: same | — |  |
...
| E8<br>APPROVED | Investments (laptop, phone); Your money story (laptop, phone); Words (laptop, phone)<br><sub>`shared:termTip.newTab`</sub> | (opens in a new tab) | 0.5 | Nothing needs you: same<br>Brand-new: same | — |  |
...
| E11<br>APPROVED | Investments (laptop, phone); Your money story (laptop, phone); Practice (after buying)<br><sub>`shared:dataNotes.stock`</sub> | Stock prices on Sept. 19, 2025, March 2, 2026 and Sept. 18, 2026 are real. Prices on the days between are modeled. | 4.8 | Nothing needs you: same<br>Brand-new: same | — |  |
| E12<br>APPROVED | Investments (laptop, phone); Your money story (laptop, phone)<br><sub>`shared:dataNotes.crypto`</sub> | Powered by CoinGecko API | label | Nothing needs you: same<br>Brand-new: same | — |  |
...
| E15<br>APPROVED | Investments (laptop, phone); Your money story (laptop, phone); Words (laptop, phone)<br><sub>`shared:dataNotes.newTab`</sub> | (opens in a new tab) | 0.5 | Nothing needs you: same<br>Brand-new: same | — |  |
...
| E20<br>APPROVED | Your money story (laptop, phone); Home (laptop); Word explanation; Practice (after buying)<br><sub>`shared:mixGroups.summary`</sub> | Your balance by kind: Stocks 61%, Crypto 17%, Cash 22%. *(and 1 more like it)* | 6.0 | Nothing needs you: “Your balance by kind: Stocks 78%, Crypto 22%, Cash 0.2%.”<br>Brand-new: not shown | — |  |
...
| N2<br>APPROVED | Home (laptop, phone); Alerts (laptop, phone); Investments (laptop, phone); and 3 more screens<br><sub>`shared:change.down`</sub> | down $1.67 *(and 16 more like it)* | label | Nothing needs you: “down $1.44”<br>Brand-new: same | — |  |
